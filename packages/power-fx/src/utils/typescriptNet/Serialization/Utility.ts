...
export function toString(value: Primitive | ISerializable | undefined | null, defaultForUnknown?: string): string {
  let v = <any>value
  switch (typeof v) {
    case Type.STRING:
      return v
    ...
    default:
      ...
      if (isSerializable(v)) return v.serialize()
      else if (defaultForUnknown) return defaultForUnknown
...
export function toPrimitive(
  ...
  unknownHandler?: (v: string) => string,
