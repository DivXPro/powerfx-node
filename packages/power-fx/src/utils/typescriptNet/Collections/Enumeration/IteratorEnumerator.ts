 ...
 *
 */
export class IteratorEnumerator<T> extends SimpleEnumeratorBase<T> {
  /**
   * @param _iterator
   * @param _isEndless true and false are explicit where as undefined means 'unknown'.
   */
  constructor(private readonly _iterator: IIterator<T>, private readonly _isEndless?: boolean) {
    super()
  }
...
export class FiniteIteratorEnumerator<T> extends IteratorEnumerator<T> implements FiniteIEnumerator<T> {
  /**
   * @param iterator
   */
...
export class EndlessIteratorEnumerator<T> extends IteratorEnumerator<T> implements EndlessIEnumerator<T> {
  /**
   * @param iterator
   */
  constructor(iterator: IIterator<T>) {
