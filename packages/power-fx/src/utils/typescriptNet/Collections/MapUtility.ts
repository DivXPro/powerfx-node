 ...
 * @returns {any}
 */
export function apply<T extends IMap<any>, U extends IMap<any>>(target: T, source: U): T & U {
 ...
 * @returns {any}
 */
export function ensure<T extends IMap<any>, U extends IMap<any>>(target: T, defaults: U): T & U {
  const result: any = target || {}
 ...
 * @param b
 */
export function merge<A extends IMap<any>, B extends IMap<any>>(a: A, b: B): A & B {
 ...
 * @param keyMap
 */
export function trim<TResult extends IMap<any>>(target: IMap<any>, keyMap: TResult): void {
  //Partial<TResult>
