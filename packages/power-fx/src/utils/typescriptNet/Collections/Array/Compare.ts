...
export function areAllEqual(arrays: ArrayLike<ArrayLike<any>>, equalityComparer?: EqualityComparison<any>): boolean
...
export function areAllEqual(
  ...
  equalityComparer: EqualityComparison<any> = Values.areEqual,
): boolean {
 ...
 */
export function areEqual<T>(a: ArrayLike<T>, b: ArrayLike<T>, equalityComparer?: EqualityComparison<T>): boolean
...
export function areEqual<T>(
  ...
  equalityComparer: EqualityComparison<T> = Values.areEqual,
): boolean {
...
export function areEquivalent<T>(a: ArrayLike<T>, b: ArrayLike<T>, comparer: Comparison<T> = Values.compare): boolean {
  const len = validateSize(a, b)
  if (Type.isBoolean(len)) return <boolean>len
