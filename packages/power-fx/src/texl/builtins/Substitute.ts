...
export class SubstituteFunction extends BuiltinFunction {
  ...
  public getSignatures() {
    return [
      [TexlStrings.SubstituteFuncArg1, TexlStrings.SubstituteFuncArg2, TexlStrings.SubstituteFuncArg3],
      [
...
export class SubstituteTFunction extends BuiltinFunction {
  ...
  public getSignatures() {
    return [
      [TexlStrings.SubstituteTFuncArg1, TexlStrings.SubstituteFuncArg2, TexlStrings.SubstituteFuncArg3],
      [
  ...
  public checkInvocation(
    ...
    if (type1.isTable) {
      let checkStringColumnType = super.checkStringColumnType(type1, args[1], errors, nodeToCoercedTypeMap)
      nodeToCoercedTypeMap = checkStringColumnType[1]
      fValid = fValid && checkStringColumnType[0]
      ...
      if (type1.coercesTo(DType.String)) {
        nodeToCoercedTypeMap = CollectionUtils.AddDictionary(nodeToCoercedTypeMap, args[1], DType.String)
      } else {
        fValid = false
    ...
    if (type2.isTable) {
      let checkStringColumnType = super.checkStringColumnType(type2, args[2], errors, nodeToCoercedTypeMap)
      nodeToCoercedTypeMap = checkStringColumnType[1]
      fValid = fValid && checkStringColumnType[0]
      ...
      if (type2.coercesTo(DType.String)) {
        nodeToCoercedTypeMap = CollectionUtils.AddDictionary(nodeToCoercedTypeMap, args[2], DType.String)
      } else {
        fValid = false
    ...
    if (hasCount) {
      ...
      if (type3.isTable) {
        let CheckNumericColumnType = super.checkNumericColumnType(type3, args[3], errors, nodeToCoercedTypeMap)
        ...
        if (type3.coercesTo(DType.Number)) {
          nodeToCoercedTypeMap = CollectionUtils.AddDictionary(nodeToCoercedTypeMap, args[3], DType.Number)
        } else {
          fValid = false
          errors.ensureErrorWithSeverity(DocumentErrorSeverity.Severe, args[3], TexlStrings.ErrNumberExpected)
        }
      }
    }
