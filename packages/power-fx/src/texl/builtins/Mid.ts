...
export class MidFunction extends BuiltinFunction {
  ...
  public getSignatures() {
    return [
      ...
      [TexlStrings.StringFuncArg1, TexlStrings.StringFuncArg2, TexlStrings.StringFuncArg3],
    ]
  }
}
...
export class MidTFunction extends BuiltinFunction {
  ...
  constructor() {
    super(undefined, 'Mid', undefined, TexlStrings.AboutMidT, FunctionCategories.Table, DType.EmptyTable, 0, 2, 3)
  }

  public getSignatures() {
    return [
      [TexlStrings.StringTFuncArg1, TexlStrings.StringFuncArg2],
      [TexlStrings.StringTFuncArg1, TexlStrings.StringFuncArg2, TexlStrings.StringFuncArg3],
    ]
  ...
  public checkInvocation(
    ...
    if (type0.isTable) {
      ...
      returnType = DType.CreateTable(new TypedName(DType.String, MidTFunction.OneColumnTableResultName))
