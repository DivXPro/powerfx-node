...
export class Library {
  ...
  public static ReplaceBlankWithZeroForSpecificIndices = LibStandardErrorHanding.ReplaceBlankWithZeroForSpecificIndices
  ...
  public static ExactValueTypeOrBlankProvider = LibStandardErrorHanding.ExactValueTypeOrBlankProvider
  public static ExactValueTypeOrBlank = LibStandardErrorHanding.ExactValueTypeOrBlank
  public static ExactValueTypeOrTableOrBlankProvider = LibStandardErrorHanding.ExactValueTypeOrTableOrBlankProvider
  ...
  private static readonly _funcsByName = new Dictionary<TexlFunction, FunctionPtr>([
    ...
    [
      ...
      Library.StandardErrorHandling<NumberValue>(
        ...
        Library.DoNotReplaceBlank,
        Library.ExactValueTypeOrBlankProvider('NumberValue'),
        Library.ExactSequence(Library.PositiveNumberChecker, Library.FiniteChecker, Library.FiniteChecker),
        ReturnBehavior.ReturnBlankIfAnyArgIsBlank,
        Library.Date,
      ),
    ],
    ...
    [
      ...
      Library.StandardErrorHandling<FormulaValue>(
        Library.InsertDefaultValues(2, new NumberValue(IRContext.NotInSource(FormulaType.Number), 1)),
        Library.DoNotReplaceBlank,
        Library.ExactSequence(
          Library.ExactValueTypeOrBlankProvider('TableValue'),
          Library.ExactValueTypeOrBlankProvider('NumberValue'),
    ...
    [
      ...
      Library.StandardErrorHandling<NumberValue>(
        Library.InsertDefaultValues(2, new NumberValue(IRContext.NotInSource(FormulaType.Number), 10)),
        Library.DoNotReplaceBlank,
        Library.ExactValueTypeOrBlankProvider('NumberValue'),
        Library.StrictPositiveNumberChecker,
        ReturnBehavior.ReturnBlankIfAnyArgIsBlank,
    ...
    [
      ...
      Library.StandardErrorHandling<BooleanValue>(
        Library.NoArgExpansion,
        Library.ReplaceBlankWith(new BooleanValue(IRContext.NotInSource(FormulaType.Boolean), false)),
    ...
    [
      ...
      Library.StandardErrorHandling<NumberValue>(
        Library.InsertDefaultValues(3, new NumberValue(IRContext.NotInSource(FormulaType.Number), 1)),
        Library.DoNotReplaceBlank,
        Library.ExactValueTypeOrBlankProvider('NumberValue'),
        Library.FiniteChecker,
        ReturnBehavior.ReturnBlankIfAnyArgIsBlank,
    ...
    [
      ...
      Library.StandardErrorHandling<FormulaValue>(
        Library.InsertDefaultValues(3, new StringValue(IRContext.NotInSource(FormulaType.String), 'Ascending')),
        Library.DoNotReplaceBlank,
        Library.ExactSequence(
          Library.ExactValueTypeOrBlankProvider('TableValue'),
          Library.ExactValueTypeOrBlankProvider('LambdaFormulaValue'),
    ...
    [
      ...
      Library.StandardErrorHandling<NumberValue>(
        Library.InsertDefaultValues(4, new NumberValue(IRContext.NotInSource(FormulaType.Number), 0)),
        Library.ReplaceBlankWithZero,
        Library.ExactValueTypeOrBlankProvider('NumberValue'),
        Library.FiniteChecker,
        ReturnBehavior.AlwaysEvaluateAndReturnResult,
    ...
    [
      ...
      Library.StandardErrorHandling<NumberValue>(
        Library.InsertDefaultValues(2, new NumberValue(IRContext.NotInSource(FormulaType.Number), 0)),
        Library.ReplaceBlankWithZero,
        Library.ExactValueTypeProvider('NumberValue'),
        Library.FiniteChecker,
        ReturnBehavior.AlwaysEvaluateAndReturnResult,
  ...
  public static StandardTableNodeRecords(irContext: IRContext, args: FormulaValue[]): Array<DValue<RecordValue>> {
  ...
  public static async If(props: TargetFunctionFullProps<FormulaValue>): Promise<FormulaValue> {
    ...
    for (let i = 0; i < args.length - 1; i += 2) {
      const res = await runner.evalArgAsync<BooleanValue>(args[i], symbolContext, args[i].irContext)
      ...
      if (res.isValue) {
        ...
        if (test.value) {
          ...
          return (
            await runner.evalArgAsync<ValidFormulaValue>(trueBranch, symbolContext, trueBranch.irContext)
          ).toFormulaValue()
        }
      }
      ...
      if (res.isError) {
        ...
        const resultContext = new IRContext(res.error.irContext.sourceContext, irContext.resultType)
      ...
      if (i + 2 == args.length - 1) {
        ...
        return (
          await runner.evalArgAsync<ValidFormulaValue>(falseBranch, symbolContext, falseBranch.irContext)
        ).toFormulaValue()
      }
  ...
  public static async IfError(props: TargetFunctionFullProps<FormulaValue>): Promise<FormulaValue> {
    const { visitor: runner, symbolContext, irContext, values: args } = props
    for (let i = 0; i < args.length - 1; i += 2) {
      const res = await runner.evalArgAsync<ValidFormulaValue>(args[i], symbolContext, args[i].irContext)
      ...
      if (res.isError) {
        ...
        for (const error of res.error.errors) {
          const kindProperty = new NamedValue('Kind', FormulaValue.New(error.kind))
          const messageProperty = new NamedValue(
            'Message',
            error.message == null
              ? FormulaValue.NewBlank(FormulaType.String)
              : FormulaValue.New(error.message),
          )
          const errorScope = new InMemoryRecordValue(IRContext.NotInSource(new RecordType(ErrorType.ReifiedError())), [
            kindProperty,
            messageProperty,
          ])
        ...
        return (
          await runner.evalArgAsync<ValidFormulaValue>(errorHandlingBranch, childContext, errorHandlingBranch.irContext)
        ).toFormulaValue()
      }
