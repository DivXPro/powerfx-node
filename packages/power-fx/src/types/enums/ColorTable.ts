export class ColorTable {
  ...
  private static readonly _invariantNameToHexMap: Map<string, number> = new Map<string, number>([
  ...
  public static get InvariantNameToHexMap() {
    return this._invariantNameToHexMap
  }

  static ToString() {
    // Contracts.Assert(_invariantNameToHexMap.All(x => !CharacterUtils.HasSpaces(x.Key)));
    let colors: string[] = []
    this._invariantNameToHexMap.forEach((val, key) => {
      colors.push(`${key}:#${val.toString(16)}`)
    })
